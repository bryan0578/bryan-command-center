  ...
  return (
    <Card variant="elevated" radius="section" className="p-6">
      ...
      <div className="mt-5 flex items-center gap-5">
        <div className="font-mono text-[44px] leading-none font-semibold tracking-[-0.02em] text-ink-primary md:text-[54px]">
          {t.time}
        </div>
        <div className="flex-1">
          <div className="mb-[9px] flex items-center gap-[7px] font-mono text-[11px] tracking-[0.07em] text-ink-muted uppercase">
            {t.running && (
